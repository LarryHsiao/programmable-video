...
class ProgrammableVideoPlugin extends ProgrammableVideoPlatform {
  ...
  static void _createLocalViewFactory(
      String localParticipantSid, VideoRenderMode mode) {
  ...
  static void _createRemoteViewFactory(String remoteParticipantSid,
      String remoteVideoTrackSid, VideoRenderMode mode) {
    ui.platformViewRegistry.registerViewFactory(
      ...
      if (remoteVideoTrack != null) {
        ...
        return DivElement()
          ..append(remoteVideoTrackElement);
      } else {
        // TODO: review behaviour in scenario where `_room` is `null`.
        return DivElement();
      }
